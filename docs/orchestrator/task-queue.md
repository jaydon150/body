...
- `[!] P1.05` Asset Pipeline: Blender headless cleanup — **blocked on user confirming Blender 4.x is installed and on PATH.**
- `[ ] P1.06` Asset Pipeline: decimate-lods (also Blender-bound)
