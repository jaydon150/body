...
- `[ ] P1.08` Asset Pipeline: bake registry (consumes the validation report; rebuilds `mesh-asset-manifest.json` from canonical/meshes/ + ontology; synthesizes the sternum composite; supersedes the user's procedural-femur-proxy seed entry)
